 ...
 */
/**
 * Copyright (c) 2019 Sohu. All Rights Reserved
 */
...
public class StartService {
    ...
    public static void startInJar() throws Exception {
        ...
        // 获取jar包里面的webapp路径
        final URL webappUrl = StartService.class.getClassLoader().getResource("webapp");
    ...
    private static Boolean isInJar() throws IOException {
        String classPath = StartService.class.getProtectionDomain().getCodeSource().getLocation().toExternalForm();
